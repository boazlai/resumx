...
| `name-caps`            | `small-caps`                             | 姓名大小寫 (`small-caps`, `all-small-caps`, `normal`) |
...
| `section-title-italic` | `normal`                                 | 區塊標題斜體 (`normal`, `italic`)                     |
| `section-title-color`  | `var(--text-color)`                      | 區塊標題顏色                                          |
| `section-title-border` | `1.5px solid var(--section-title-color)` | 區塊標題底線邊框                                      |
...
| `entry-title-italic`   | `normal`                                 | 項目標題斜體 (`normal`, `italic`)                     |
...
| 變數         | 預設值   | 描述                        |
| ------------ | -------- | --------------------------- |
| `auto-icons` | `inline` | 圖示顯示 (`inline`, `none`) |
