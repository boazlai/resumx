...
| `name-caps`            | `small-caps`                             | 名字大小写 (`small-caps`, `all-small-caps`, `normal`) |
...
| `section-title-italic` | `normal`                                 | 章节标题斜体 (`normal`, `italic`)                     |
| `section-title-color`  | `var(--text-color)`                      | 章节标题颜色                                          |
| `section-title-border` | `1.5px solid var(--section-title-color)` | 章节标题下划线边框                                    |
...
| `entry-title-italic`   | `normal`                                 | 条目标题斜体 (`normal`, `italic`)                     |
...
| 变量         | 默认值   | 描述                        |
| ------------ | -------- | --------------------------- |
| `auto-icons` | `inline` | 图标显示 (`inline`, `none`) |
