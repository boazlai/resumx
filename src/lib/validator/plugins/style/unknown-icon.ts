 ...
 * Unknown Icon Plugin
 *
 * Validates icon references in the resume, ensuring that icon references
 * (using the `::icon::` syntax) point to valid icons in the supported icon libraries.
 *
 * ## Checks
 *
 ...
 * - **Iconify**: Any Iconify icon set with colon syntax (e.g., `::mdi:home::`)
 * - **GitHub**: GitHub user/org avatars (e.g., `::gh:octocat::`)
 * - **Wikimedia**: Wikipedia/Commons images (e.g., `::wiki:path/to/icon.svg::`)
 *
 * ## Examples
 *
 * ```markdown
 ...
 * ```
 *
 * @module validator/plugins/style/unknown-icon
 */
