 ...
 * 3. wrapSections - wrap h2 groups in <section> tags (before columns so no layout awareness needed)
 * 4. wrapEntries - wrap h3 groups in <article class="entry"> tags (before columns so no layout awareness needed)
 * 5. processColumns - handle <hr>, create two-column layout (operates on already-wrapped sections)
 * 6. classifySections - add data-section attrs for JSON Resume types
 * 7. classifyHeader - wrap contact info in <address>, add data-field attrs
 */
